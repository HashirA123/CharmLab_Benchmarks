...
class BostonHousingData(DataObject):
    def __init__(self, data_path, config_path = None, config_override = None):
    ...
    def _read_raw_data(self):
        ...
        * This method must create the following member variables:
        ...
        self._raw_df = pd.read_csv(self._data_path).reset_index(drop=True)
